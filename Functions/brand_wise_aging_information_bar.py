...
def stock_aging_chart(name):
    try:
        ...
        bars = plt.bar(list_of_label, height=list_to_brand, color=colors, width=.6)
        ...
        print('8.1 Brand wise Stock Aging figure generated ')
        ...
        ax.tight_layout()
        print('8.1 Error !!!! brand wise Stock Aging figure not generated\n')
