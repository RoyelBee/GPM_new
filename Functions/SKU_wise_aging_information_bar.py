...
Group by  AGEING)as T3
        ...
        one_eighty_sku = executive_target_df['180 Days SKU'].tolist()
        two_ten_sku = executive_target_df['Within 210 Days SKU'].tolist()

        list_to_sku = [Expired_sku[0], fifteen_days_sku[0], thirty_days_sku[0], sixty_days_sku[0], ninety_days_sku[
            0], one_eighty_sku[0], two_ten_sku[0]]

        total = sum(list_to_sku)
